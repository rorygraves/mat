...
public final class Messages {
    ...
    public static String CategoryDescriptor_Label_NoCategory="<uncategorized>";
    ...
    public static String QueryDescriptor_Error_IgnoringQuery="Ignoring query {0} due to argument {1}";
    ...
    public static String QueryPart_Error_IgnoringResult="Ignoring result of ''{0}'' due to {1}";
    public static String QueryPart_Error_InvalidProvider="Invalid configuration parameter {0}: expected <provider>=<operation>: {1}";
    public static String QueryPart_Error_InvalidProviderOperation="Invalid configuration parameter {0}: unknown operation: {1}";
    public static String QueryPart_Error_MissingEqualsSign="Missing ''='' sign in filter ''{0}''";
    public static String QueryPart_Error_NoCommand="No command specified for test ''{0}'' of section ''{1}''";
    ...
    public static String QueryRegistry_Error_Registering="Error registering query: {0}";
    public static String QueryRegistry_MissingLabel="Missing label: {0} for menu entry number {1}.";
    public static String QueryRegistry_Msg_QueryRegistered="Query registered: {0}";
    ...
    public static String RegistryReader_Error_Registry="Error while creating: ''{0}''";
    public static String RendererRegistry_Error_MissingAnnotation="Class must be annotated as Renderer: {0}";
    public static String ReportPlugin_InternalError="Internal Error";
    public static String ResultRenderer_Error_OutputterNotFound="No outputter found for format ''{0}'' and type ''{1}''";
    ...
    public static String ConsoleProgressListener_ERROR="[ERROR] ";
    public static String ConsoleProgressListener_INFO="[INFO] ";
    public static String ConsoleProgressListener_UNKNOWN="[UNKNOWN] ";
    public static String ConsoleProgressListener_WARNING="[WARNING] ";
