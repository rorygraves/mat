...
public class Messages {
    ...
    public static String BundleReaderFactory_ErrorMsg_EquinoxNotFound="Could not find Equinox OSGi Framework.";
    public static String BundleRegistryQuery_Bundles="Bundles";
    public static String BundleRegistryQuery_BundleState="Bundle State";
    public static String BundleRegistryQuery_BundlesUsing="Bundles Using";
    public static String BundleRegistryQuery_ContributedBy="contributed by: {0}";
    public static String BundleRegistryQuery_Dependencies="Dependencies";
    public static String BundleRegistryQuery_Dependents="Dependents";
    public static String BundleRegistryQuery_ErrorMsg_FailedReadingModel="Failed reading bundle from OSGiModel";
    public static String BundleRegistryQuery_ExtensionPoints="Extension Points";
    public static String BundleRegistryQuery_Extensions="Extensions";
    public static String BundleRegistryQuery_Fragments="Fragments";
    public static String BundleRegistryQuery_HostedBy="hosted by: {0}";
    public static String BundleRegistryQuery_Properties="Properties";
    public static String BundleRegistryQuery_RegisteredBy="registered by: {0}";
    public static String BundleRegistryQuery_RegisteredServices="Registered Services";
    public static String BundleRegistryQuery_Services="Services";
    public static String BundleRegistryQuery_UserServices="Used Services";
    ...
    public static String ClassSpecificNameResolverRegistry_Error_CreateResolver="Error while creating name resolver ''{0}''";
    public static String ClassSpecificNameResolverRegistry_Error_MissingObject="No object to resolve class specific name for.";
    public static String ClassSpecificNameResolverRegistry_Error_MissingSubjects="Resolver without subjects: ''{0}''";
    public static String ClassSpecificNameResolverRegistry_Error_Resolving="Error resolving name of {0}";
    public static String ClassSpecificNameResolverRegistry_ErrorMsg_DuringResolving="Error resolving name of {0}";
    public static String ClassSpecificNameResolverRegistry_ErrorMsg_MissingSubject="Resolver without subjects: ''{0}''";
    public static String ClassSpecificNameResolverRegistry_ErrorMsg_WhileCreatingResolver="Error while creating name resolver ''{0}''";
    ...
    public static String EquinoxBundleReader_CannotFindContributorID="Could not parse contributorId. Expected a number but got \"{0}\"";
    public static String EquinoxBundleReader_ErrorMsg_BundleNotFound="Bundle host not found: 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_DuplicateConfigurationElement="Duplicate configuration element: {0}, first object address: 0x{1}, second object address: 0x{2}";
    public static String EquinoxBundleReader_ErrorMsg_DuplicateExtension="Duplicate extension: {0}, first object address: 0x{1}, second object address: 0x{2}";
    public static String EquinoxBundleReader_ErrorMsg_DuplicateExtensionPoint="Duplicate extension point: {0}, first object address: 0x{1}, second object address: 0x{2}";
    public static String EquinoxBundleReader_ErrorMsg_ExpectedArrayType="Expected array type: 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ExpectedFieldExtraInformation="Expected ''extraInformation'': 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ExpectedFieldObjectId="Expected field ''objectId'': 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ExpectedFieldParent="Expected field ''parentId'': 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ExpectedStringArray="Expected ''propertiesAndValues'' in String[] format: 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ReadingProperty="Error reading property of ConfigurationElement: 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ServiceName="Error reading service''s name: 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_ServiceProperty="Error reading Service property: 0x{0}";
    public static String EquinoxBundleReader_ErrorMsg_SoftReferencesNotHandled="Extension 0x{0} has properties in the form of SoftReference. Not handled.";
    public static String EquinoxBundleReader_ErrorMsg_UnknownElementType="Unknown element 0x{0} of type {1}";
    public static String EquinoxBundleReader_ExpectedFieldContributorId="Expected field ''contributorId'': 0x{0}";
    public static String EquinoxBundleReader_ExpectedFieldPropertiesAndValues="Expected field ''propertiesAndValues'': 0x{0}";
    public static String EquinoxBundleReader_NotApplicable="N/A";
    public static String EquinoxBundleReader_ProcessListenerBundles="Bundles";
    public static String EquinoxBundleReader_ReadingBundles="Reading bundles";
    public static String EquinoxBundleReader_ReadingExtensions="Reading extensions";
    public static String EquinoxBundleReader_ReadingServices="Reading services";
    public static String EquinoxBundleReader_State_Active="active";
    public static String EquinoxBundleReader_State_Installed="installed";
    public static String EquinoxBundleReader_State_Resolved="resolved";
    public static String EquinoxBundleReader_State_Starting="starting";
    public static String EquinoxBundleReader_State_Stopping="stopping";
    public static String EquinoxBundleReader_State_Uninstalled="uninstalled";
    ...
    public static String FinalizerThreadQuery_ErrorMsg_MultipleFinalizerThreadClasses="Error: Snapshot contains multiple instances of java.lang.ref.Finalizer$FinalizerThread class.";
    ...
    public static String HeapDumpProviderRegistry_ErrorGettingArgumentErrorMsg="Error get argument ''{0}'' of class ''{1}''";
    public static String HeapDumpProviderRegistry_NameAlreadyBouneErrorMsg="Heap dump adapter name ''{0}'' is already bound to {1}!";
    public static String HeapDumpProviderRegistry_UnableToAccessArgumentErrorMsg="Unable to access argument ''{0}'' of class ''{1}''. Make sure the attribute is PUBLIC.";
    public static String HeapDumpProviderRegistry_WrongTypeErrorMsg="Field {0} of {1} has advice {2} but is not of type {3}.";
    ...
    public static String HeapObjectContextArgument_Label_Context="[context]";
    ...
    public static String JettyNameResolvers_JSPofWebApp="JSPs of {0}";
    public static String JettyRequestResolver_Collection="Collection";
    public static String JettyRequestResolver_Msg_ThreadExecutesHTTPRequest="The thread is executing an HTTP Request to <strong>{0}</strong>.";
    public static String JettyRequestResolver_Parameters="Parameters";
    public static String JettyRequestResolver_Summary="Summary";
    public static String JettyRequestResolver_URI="URI";
    ...
    public static String LeakHunterQuery_TicketForSuspect="{0} for &quot;{1}&quot;";
    ...
    public static String MATPlugin_InternalError="Internal Error";
    ...
    public static String ParseSnapshotApp_ErrorMsg_FileNotFound="File not found: {0}";
    public static String ParseSnapshotApp_ErrorMsg_ReportNotFound="Report not found: {0}";
    public static String ParseSnapshotApp_Usage="Usage: [options] <snapshot> [(<report id>)*]";
    public static String ParseSnapshotApp_MultipleSnapshotsDetail="Snapshot identifier: {0} Information: {1}";
    public static String ParseSnapshotApp_MultipleSnapshotsDetected="Multiple heap dump snapshots have been detected in the file being analyzed. Use the 'runtime_identifier' option to select which snapshot to process.";
    ...
    public static String RetainedSizeDerivedData_Error_IllegalContext="Context provider ''{0}'' returned an illegal context object set for ''{1}'' with content ''{2}''. Return null instead.";
    public static String RetainedSizeDerivedData_Error_IllegalObjectId="Context provider ''{0}'' returned an context object with an illegeal object id for ''{1}''. Return null instead.";
    ...
    public static String Service_ErrorMsg_MismatchKeysServices="Number of keys does not correspond to the number of values for the service: 0x{0}";
    public static String SnapshotFactory_Error="Error during creation of snapshot factory.";
    public static String SnapshotFactory_ErrorMsg_FactoryCreation="Error during creation of snapshot factory.";
    ...
    public static String SubjectRegistry_Error_MissingAnnotation="Missing or empty @Subject(s) annotation: ''{0}''";
    public static String SubjectRegistry_ErrorMsg_MissingSubjectAnnotation="Missing or empty @Subject(s) annotation: ''{0}''";
    ...
    public static String ThreadInfoImpl_Column_Instance="Instance";
    ...
    public static String TQuantize_Label_GroupByClassLoader="Group by class loader";
    public static String TQuantize_Label_GroupByPackage="Group by package";
    public static String TQuantize_Label_GroupedByClassLoader="Grouped ''{0}'' by class loader";
    public static String TQuantize_Label_GroupedByPackage="Grouped ''{0}'' by package";
    public static String TQuantize_None="<none>";
    public static String VmInfoDescriptor_ErrorGettingArgumentErrorMsg="Error get argument ''{0}'' of class ''{1}''";
    public static String VmInfoDescriptor_UnableToAccessArgumentErrorMsg="Unable to access argument ''{0}'' of class ''{1}''. Make sure the attribute is PUBLIC.";
    public static String VmInfoDescriptor_WrongTypeErrorMsg="Field {0} of {1} has advice {2} but is not of type {3}.";
