...
@CommandName("comparetablesquery")
public class CompareTablesQuery implements IQuery {
    ...
    public class TableComparisonResult implements IResultTable {
        private Column key;
                            ...
                            public IContextObject getContext(final Object row) {
                                ...
                                return new IContextObjectSet() {
                                    ...
                                    private String OQLexcept(String oql1, String oql2) {
                                        ...
                                        oql1 = "SELECT * FROM OBJECTS (" + oql1 + ")" +
                                                " WHERE @objectId not in (" + oql2 + ")";
                                        return oql1;
                                    }
