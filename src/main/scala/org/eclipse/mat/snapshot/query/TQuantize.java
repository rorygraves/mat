...
public final class TQuantize {
    ...
    public enum Target {
         ...
         */
        PACKAGE(Messages.TQuantize_Label_GroupByPackage, Messages.TQuantize_Label_GroupedByPackage,
                ByPackage.class);
        ...
        private Target(String label, String title, Class<? extends Calculator> calculatorClass) {
            this.label = label;
            this.title = title;
    ...
    static class OneColumnFlatResult implements IResultTree {
        IResultTable table;
    ...
    static class ByPackageResult implements IResultTree {
        Package root;
        IResultTable table;
        List<Column> columns;
