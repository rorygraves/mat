 ...
 * class loader.
 */
public class Histogram extends HistogramRecord implements IResultTable {
     ...
     *
     * @param baseline baseline histogram
     ...
     *
     * @param another another histogram
     ...
     *
     * @param histogram  histogram you want a human reable text based report for
     * @param comparator comparator to be used for sorting the histogram records (
     ...
     *
     * @param histogram  histogram you want a machine/human readable comma separated
     *                   report for
     * @param comparator comparator to be used for sorting the histogram records (
     *                   {@link HistogramRecord} provides some default comparators)
    ...
    public final static class ClassLoaderTree implements IResultTree {
    ...
    public static final class PackageTree implements IResultTree {
        private Histogram histogram;
        PackageNode root;
        ...
        private void buildTree(Histogram histogram) {
            root = new PackageNode("<ROOT>", null);
                ...
                return new IContextObjectSet() {
                    ...
                    public String getOQL() {
                        if (histogram.isDefaultHistogram()) {
                            ...
                            while (n.parent != null) {
                                // Escape the dot
                                partialPack.insert(0, "\\.");
                                partialPack.insert(0, n.label);
                                n = n.parent;
                            }
                            Pattern pattern = Pattern.compile(partialPack.toString() + ".*");
     ...
     * @since 1.0
     */
    public static final class SuperclassTree implements IResultTree {
        private Histogram histogram;
        SuperclassNode root;
