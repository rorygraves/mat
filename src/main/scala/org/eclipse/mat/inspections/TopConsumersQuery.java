...
public class TopConsumersQuery implements IQuery {
    ...
    public IResult execute(IProgressListener listener) throws Exception {
        ...
        // Print the results
        out.println();
        out.println(Messages.TopConsumers2Query_BiggestObjects + ":");
        ...
        out.println();
        out.println(Messages.TopConsumers2Query_BiggestClasses + ":");
        out.println(SEPARATOR);
        ...
        out.println();
        out.println(Messages.TopConsumers2Query_BiggestClassLoaders + ":");
        out.println(SEPARATOR);
        ...
        out.println();
        out.println(Messages.TopConsumers2Query_BiggestPackages + ":");
        out.println(SEPARATOR);
